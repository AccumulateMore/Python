...
2. Pycharm 的 Jupyter Notebook 打开笔记时，图片不会正常显示，笔记是用 Anaconda 的 Jupyter Notebook 打开的。（不会打开笔记的，百度查一下"Anaconda如何打开Jupyter Notebook文件"，或者"00_Python编辑器"里面有写。）
...
| 需要零基础指导（一两个月足够了，从零基础到中级）<br/> | 指导改简历<br/> | 内推就业<br> |
...
补充：能提供项目的，也可以联系我，把项目职责、项目效果发给我【你收学生付费咨询、ta们学习技术，双赢】。
